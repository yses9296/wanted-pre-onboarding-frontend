...
export async function signUpRequest({ email, password }: Auth): Promise<SignUpResponseAuth> {
...
export async function signInRequest({ email, password }: Auth): Promise<SignInResponseAuth> {
	return new Promise((resolve, reject) => {
